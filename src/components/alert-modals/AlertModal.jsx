...
const AlertModal = ({msg, alertType, alertTitle, setMsg}) => {
  return (
    <>
        <div className="h-full w-full fixed top-0 left-0 z-[99]" style={{ background:"rgba(14, 14, 14, 0.58)" }} onClick={() => setMsg('')}></div>
