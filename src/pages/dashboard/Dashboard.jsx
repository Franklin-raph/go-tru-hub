                    ...
                    allWithdrawals?.map((item, index) => {
                      ...
                      return(
                        <div className="flex text-[14px] justify-between mb-5">
                          ...
                          {
                            item?.status === "pending" && <p className="flex items-center gap-[2px] text-[#9A2525]"><TbCurrencyNaira className="text-[20px]"/>{item.amount}</p>
                          }
                          {
                            item?.status === "rejected" && <p className="flex items-center gap-[2px]"><TbCurrencyNaira className="text-[20px]"/>{item.amount}</p>
                          }
                        </div>
                      )
                    })
