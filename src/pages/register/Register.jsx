  ...
  return (
    <div className='w-[100%] mx-auto my-[4rem]'>
      <div className='w-[50%] mx-auto'>
        ...
        <div className='border rounded-[4px] px-4 py-3 w-[80%] mx-auto'>
          <p className='text-[#19201D] font-[600] text-[26px] cursor-pointer'>Registered Organizations</p>
          <p className='text-[#6F7975] mt-4'>Companies with Registered CAC</p>
        </div>
        <div className='border rounded-[4px] px-4 py-3 w-[80%] mx-auto my-10 cursor-pointer'>
          <p className='text-[#19201D] font-[600] text-[26px]'>Personal Businesses</p>
          <p className='text-[#6F7975] mt-4'>Businesses not registered</p>
        </div>
        <div className='border rounded-[4px] px-4 py-3 w-[80%] mx-auto cursor-pointer'>
